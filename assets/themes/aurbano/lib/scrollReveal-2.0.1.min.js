! function (e, t) {
	...
	return window.scrollReveal = function (e) {
		...
		function t(t) {
			r = this, r.elems = {}, r.serial = 1, r.blocked = !1, r.config = o(r.defaults, t), (!r.isMobile() || r.config.mobile) && (r.config.viewport == e.document.documentElement ? (e.addEventListener("scroll", n, !1), e.addEventListener("resize", n, !1)) : r.config.viewport.addEventListener("scroll", n, !1), r.init())
		}
		var i, o, n, r;
		return t.prototype = {
			defaults: {
			...
			init: function () {
				var e, t, i;
				i = Array.prototype.slice.call(r.config.viewport.querySelectorAll("[data-sr]")), i.forEach(function (i) {
					e = r.serial++, i.getAttribute("data-sr-id") || (i.setAttribute("data-sr-id", e), t = r.elems[e] = {
						domEl: i
					}, t.config = r.configFactory(t), t.styles = r.styleFactory(t), t.seen = !1), i.setAttribute("style", t.styles.inline + t.styles.initial)
				}), r.scrolled = r.scrollY(), r.animate(!0)
			},
			animate: function (e) {
				var t;
				for (var i in r.elems) t = r.elems[i], t.domEl.getAttribute("data-sr-complete") ? delete r.elems[i] : r.isElemInViewport(t) ? ("always" == r.config.delay || "onload" == r.config.delay && e || "once" == r.config.delay && !t.seen ? (t.domEl.setAttribute("style", t.styles.inline + t.styles.target + t.styles.transition), t.seen = !0) : t.domEl.setAttribute("style", t.styles.inline + t.styles.target + t.styles.reset), t.config.reset || setTimeout(function () {
					t.domEl.setAttribute("style", t.styles.inline), t.domEl.setAttribute("data-sr-complete", !0), t.config.complete(t.domEl)
				}, t.styles.duration)) : r.isElemInViewport(t) || t.config.reset && t.domEl.setAttribute("style", t.styles.inline + t.styles.initial + t.styles.reset);
				r.blocked = !1
			},
			...
			styleFactory: function (e) {
				...
				}, i = "transform:", o = "transform:", s(), i += "-webkit-transform:", o += "-webkit-transform:", s(), {
					transition: t,
					initial: i,
					target: o,
					reset: n,
			...
			isElemInViewport: function (t) {
				var i = t.domEl.offsetHeight,
					...
					n = o + i,
					s = t.config.vFactor || 0;
				return o + i * s < r.scrolled + r.getViewportH() && n - i * s > r.scrolled || "fixed" == (t.domEl.currentStyle ? t.domEl.currentStyle : e.getComputedStyle(t.domEl, null)).position
			},
			isMobile: function () {
